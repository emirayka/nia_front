...
const constructHelpMessage = () => {
  let s = 'Usage: <span style="color: lightgreen">define-mapping KEY-CHORDS ACTION</span><br>.'

  s += `Examples:<br>`
  s += `&nbsp;&nbsp;&nbsp;&nbsp;<span style="color: lightgreen">define-mapping 1:Caps+1:v text-type test</span><br>`
