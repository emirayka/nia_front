...
import NiaHeader1 from './NiaHeader1.vue'
import NiaHeader2 from './NiaHeader2.vue'
import NiaHeader3 from './NiaHeader3.vue'
import NiaHeader4 from './NiaHeader4.vue'
import NiaInputText from './NiaInputText.vue'
import NiaLabel from './NiaLabel.vue'
import NiaLoader from './NiaLoader.vue'
...
Vue.component('NiaInputText', NiaInputText)
Vue.component('NiaLabel', NiaLabel)
Vue.component('NiaLoader', NiaLoader)
Vue.component('NiaNavbar', NiaNavbar)
Vue.component('NiaNavbarBrand', NiaNavbarBrand)
Vue.component('NiaNavbarNav', NiaNavbarNav)
Vue.component('NiaNavbarItem', NiaNavbarItem)
Vue.component('NiaHeader1', NiaHeader1)
